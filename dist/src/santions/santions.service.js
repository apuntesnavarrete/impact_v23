...
let SantionsService = class SantionsService {
    constructor(santionsRepository) {
        this.santionsRepository = santionsRepository;
    }
    async all() {
...
exports.SantionsService = SantionsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(santions_entity_1.Santions)),
